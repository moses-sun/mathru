...
fn partial_eq_non_matching_content() {
    let a: UnitLowerTriangular<f64> = matrix![1.0, 0.0;
                                   0.0, 2.0]
    .into();
    let b: UnitLowerTriangular<f64> = matrix![2.0, 0.0;
                                   0.0, 2.0]
    .into();
...
fn partial_eq_non_matching_dimensions() {
    let a: UnitLowerTriangular<f64> = matrix![1.0, 2.0].into();
...
#[test]
fn equal() {
    let a: UnitLowerTriangular<f64> = matrix![1.0, 3.0;
                                   0.0, 2.0]
    .into();
    let b: UnitLowerTriangular<f64> = matrix![1.0, 3.0;
                                   0.0, 2.0]
    .into();
