...
//// Does not work all the time, because the used function 'random' is not
//// mocked.    #[test]
////    fn random()
////    {
////        let mean_1 : f64 = 0.0;
////        let variance_1: f64 = 1.0;
////        let distrib_1 : NormalDistrib = NormalDistrib::new(&mean_1,
//// &variance_1);        let mut data: Vec<f64> = Vec::new();
////
////        for _i in 0..10000
////        {
