...
use mathru::{
    ...
    analysis::differential_equation::ordinary::{
        solver::explicit::runge_kutta::adaptive::{ExplicitRKEmbeddedMethod, Fehlberg54},
...
fn test_1() {
    ...
    assert_relative_eq!(x_1, x_1_ref, epsilon = 0.0000025);
    assert_relative_eq!(x_1_s, x_1_ref, epsilon = 0.0000032);
}
