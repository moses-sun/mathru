...
//        let gamma: Complex<f64> = gamma::gamma(x);
//
//        assert_eq!(Complex::new(-0.7505627158730652, -0.06918543147121949),
// gamma);    }
//
//    #[test]
//    fn gamma_complex2()
...
//        let gamma: Complex<f64> = gamma::gamma(x);
//
//        assert_eq!(Complex::new(-0.5500387100945794, -0.5773132048330409),
// gamma);    }
//
//       #[test]
//    fn gamma_complex3()
...
//        let gamma: Complex<f64> = gamma::gamma(x);
//
//        assert_eq!(Complex::new(0.6078826572404026, -0.2039648953365259),
// gamma);    }
...
//        let gamma: Complex<f64> = gamma::digamma(x);
//
//        assert_eq!(Complex::new(-0.3070040353355371, 1.5503173890363635),
// gamma);    }
//
//    #[test]
//    fn digamma_complex2()
...
//        let gamma: Complex<f64> = gamma::digamma(x);
//
//        assert_eq!(Complex::new(0.2547937174734515, -2.4491937935307453),
// gamma);    }
...
//        let gamma: Complex<f64> = gamma::gamma_lr(a, x);
//
//        assert_eq!(Complex::new(1.0484003068056669, -0.26574880173515353),
// gamma);    }
//
//     #[test]
//    fn gamma_lr5()
