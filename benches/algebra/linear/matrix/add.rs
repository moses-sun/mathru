...
criterion_group!(
    add,
    bench_add_matrix_own,
    bench_add_matrix_borrow,
    bench_add_matrix_mut_borrow,
    bench_add_scalar_own,
    bench_add_scalar_mut_borrow,
    bench_add_scalar_borrow /*, bench_vector_add_vector, bench_vec_add_vec*/
);
