...
criterion_group!(
    bench_vector_sub_borrow_vector,
    vector_sub_borrow_vector,
    vec_sub_borrow_vec
);

fn vector_sub_borrow_vector(bench: &mut Criterion) {
    bench.bench_function("vector sub borrow vector", move |bh| {
