...
use crate::analysis::ode::explicit_ode1;
use mathru::analysis::differential_equation::ordinary::solver::explicit::runge_kutta::{
    adaptive::{Fehlberg54, ProportionalControl},
    fixed::{ExplicitEuler, FixedStepper, Heun2, Kutta3, RungeKutta4},
};

criterion_group!(ode, forward_euler, heun, kutta3, rungekutta4, fehlberg54,);
