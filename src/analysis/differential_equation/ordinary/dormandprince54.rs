...
impl<T> DormandPrince54<T> where T: Real
{
    /// Creates a DormandPrince54 instance, also known as explicit Runge-Kutta
    /// method of order 5(4) with step-size control
    pub fn new(abs_tol: T, begin_step_size: T, n_max: u32) -> DormandPrince54<T>
    {
        return DormandPrince54 { abs_tol,
                                 h_0: begin_step_size,
                                 n_max };
    }
    ...
    ///
    /// * 'self'
    /// * 'prob': explicit ordinary differntial equation with initial condition,
    ///   which is solved
...
impl<T> ExplicitAdaptiveMethod<T> for DormandPrince54<T> where T: Real
{
        ...
        where F: ExplicitODE<T>
    {
        ...
        // k_5 = h f(t_n + h, x_n + 19372/6561k_1 - 25360/2187k_2 + 64448/6561k_3 -
        // 212/729k_4)
        ...
        // k_6 = h f(t_n + h, x_n + 9017/3168k_1 - 355/33k_2 + 46732/5247k_3 + 49/176k_4
        // - 5103/18656k_5)
        ...
        // k_7 = h f(t_n + h, x_n + 35/384k_1 + 500/1113k_3 + 125/192k_4 - 2187/6784k_5
        // + 11/84k_6)
        ...
        // 4th order
        // y(n +1) = x_n + 5179/57600k_1 + 7571/16695k_3 + 393/640k_4 - 92097/339200k_5
        // + 187/2100k_6 + 1/40k_7
