...
impl<T> RungeKuttaFehlberg54<T> where T: Real
{
    /// Creates a Runge Kuttea Fehlberg 54 instance, also known as
    ...
    {
        return RungeKuttaFehlberg54 { stepper: AdaptiveStepper::new(n_max, h_0, fac, fac_min,
...
impl<T> Default for RungeKuttaFehlberg54<T> where T: Real
{
...
impl<T> ExplicitAdaptiveMethod<T> for RungeKuttaFehlberg54<T> where T: Real
{
        ...
        where F: ExplicitODE<T>
    {
        ...
        let k_2: Vector<T> = &prob.func(&(*t_n + *h / T::from_f64(4.0)),
                                        &(x_n + &(&k_1 / &T::from_f64(4.0))))
                             * h;
        ...
        // k_6 = h f(t_n + h/2, x_n - 8/27k_1 + 2k_2 - 3544/2565k_3 + 1859/4104k_4 -
        // 11/40k_5)
        ...
        // order 5
        // y_(n +1) = x_n + 16/135k_1 + 6656/12825k_3 + 28561/56430k_4 - 9/50k_5 +
        // 2/55k6
