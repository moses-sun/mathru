    ...
    where T: Real
{
    ...
    if z == T::one()
    {
        ...
        else
        {
            ...
            {
                return gamma::gamma(c) * gamma::gamma(c - a - b)
                       / (gamma::gamma(c - a) * gamma::gamma(c - b));
            }
        }
    }
    ...
    {
        let l1: T = (T::one() - z).pow(&-a) * gamma::gamma(c) * gamma::gamma(b - a)
                    / (gamma::gamma(b) * gamma::gamma(c - a));

        let l2: T = (T::one() - z).pow(&-b) * gamma::gamma(c) * gamma::gamma(a - b)
                    / (gamma::gamma(a) * gamma::gamma(c - b));
    ...
    else
    {
        ...
        else
        {
            ...
            else
            {
                ...
                {
                    let l1: T = gamma::gamma(c) * gamma::gamma(c - a - b)
                                / (gamma::gamma(c - a) * gamma::gamma(c - b));
                    let l2: T = (T::one() - z).pow(&(c - a - b))
                                * gamma::gamma(c)
                                * gamma::gamma(a + b - c)
