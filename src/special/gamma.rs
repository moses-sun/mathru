    ...
    ($t: ty, $PI: expr, $E: expr) => {
        ...
        impl Gamma for $t {
            fn gamma(self) -> Self {
                ...
                return 2.0.sqrt() * $PI.sqrt() * t.pow((self - 0.5)) * (-t).exp() * x;
            }
                    ...
                    if a < 0.3 && (0.35..=0.6).contains(&b) {
                        ...
                        if (0.15..0.35).contains(&b) || (0.35 <= a && (0.15..0.45).contains(&b)) {
                            ...
                            if 0.01 < b && b < 0.15 {
                                ...
                                let c_3: Self = (a - 1.0)
                                    * (-c_1_2 / 2.0 + (a - 2.0) * c_1 + (3.0 * a - 5.0) / 2.0);

                                let a_2: Self = a * a;

                                let c_1_3: Self = c_1_2 * c_1;
                                let c_4: Self = (a - 1.0)
                                    * (c_1_3 / 3.0 - (3.0 * a - 5.0) / 2.0 * c_1_2
                                        + (a_2 + -6.0 * a + 7.0) * c_1
                                ...
                                let c_5: Self = (a - 1.0)
                                    * (-c_1_4 / 4.0
                                        + (11.0 * a - 17.0) / 6.0 * c_1_3
                                        + (-3.0 * a_2 + 13.0 * a - 13.0) * c_1_2
                                        + (2.0 * a_3 - 25.0 * a_2 + 72.0 * a - 61.0) / 2.0 * c_1
